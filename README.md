...
**FPClassic** is an open-source project that aims to bring native, feature-rich support for the **PreSonus FaderPort Classic** to **FL Studio**.
...
FPClassic is being designed with reliability and simplicity in mind. Every feature will be implemented only after understanding the underlying behavior of both the FaderPort and the FL Studio scripting API, avoiding unnecessary complexity and undocumented workarounds whenever possible.
